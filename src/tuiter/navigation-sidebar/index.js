    ...
    return(
        <>
            <div className="list-group">
                ...
                <Link to="/tuiter/profile" className={`nav-link override-list list-group-item list-group-item-action ${active === 'profile' || active === 'edit-profile'?'active':''}`} href="profile.html"><i className="fas fa-user"></i><span className="d-none d-xl-inline d-lg-none p-2"> Profile</span></Link>
