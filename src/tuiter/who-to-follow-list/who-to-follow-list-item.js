            ...
            <div className="list-group-item override-bg-gray list-group-item-action">
                <div className="row">
                    <div className="col-xl-2 col-lg-2">
                        <img src={who.avatarIcon} alt="" width="48"
                             className="rounded-circle float-start"/>
                    </div>

                    <div className="col-xl-7 col-lg-6">
                        <div className="text-nowrap override-text">
                            <span className="font-middle fw-bold">{who.userName}</span>
                    ...
                    <div className="col-xl-3 col-lg-4 my-auto">
                        <a className="btn btn-primary rounded-pill override-bt" href="/">Follow</a>
                    </div>
                </div>
            </div>
        </>
